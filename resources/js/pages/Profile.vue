    ...
    <div class="md:grid md:grid-cols-1 md:gap-6 p-8 overflow-y-auto" style="max-height: 100vh;">
        <div class="bg-white p-8 shadow sm:rounded-md sm:overflow-hidden">
            ...
            <div class="inline-block">
                <input type="file" class="p6 " @change="updatePhoto">
            </div>
        </div>
        ...
        <div class="bg-white shadow sm:rounded-md sm:overflow-hidden">
            <div class="p-6">
                <div class="col-span-6 sm:col-span-4 py-2">
                    ...
                    <input type="text" v-model="me.name" name="name" id="name" autocomplete="email" class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500">
                </div>
                <div class="col-span-6 sm:col-span-4 py-2">
        ...
        <div class="bg-white shadow sm:rounded-md sm:overflow-hidden">
            <div class="p-6">
                <div class="col-span-6 sm:col-span-4 py-2">
                    <button :disabled="isLougouting" @click="logoutNow" class="w-full h-12 px-6 text-red-100 transition-colors duration-150 bg-red-700 rounded-lg focus:shadow-outline hover:bg-red-800">
                        <span v-if="isLougouting">Saindo</span>
